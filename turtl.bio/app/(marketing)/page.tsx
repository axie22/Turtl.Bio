        ...
        <div className="flex flex-col items-center">
            ...
            <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 flex flex-col items-center text-center container px-4 mx-auto">
                <h1 className="text-3xl font-extrabold leading-tight tracking-tighter md:text-5xl lg:text-6xl lg:leading-[1.1]">
                    The Workspace for <br className="hidden sm:inline" />
                ...
                <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
                    Accelerate your research with a cloud-native environment designed for bioinformatics.
                    Code, analyze, and collaborate without the infrastructure headache.
                </p>
                ...
                <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                VS Code-compatible code editor available directly in your browser.
                            </CardDescription>
                        </CardHeader>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Your data stays in your container. Enterprise-grade security for your IP.
                            </CardDescription>
                        </CardHeader>
                    </Card>
