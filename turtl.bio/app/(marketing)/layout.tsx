          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="col-span-2">
              <div className="flex items-baseline gap-2">
                <span className="text-[15px] font-semibold tracking-tight">Turtl.Bio</span>
              ...
              <p className="mt-3 max-w-md text-sm text-zinc-500 leading-relaxed">
                A structured interpretation workspace for preclinical biotech teams preparing their first IND.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/" className="hover:text-zinc-950 text-zinc-600">Index</Link></li>
                <li><Link href="/about" className="hover:text-zinc-950 text-zinc-600">About</Link></li>
                <li><Link href="/workspace" className="hover:text-zinc-950 text-zinc-600">Workspace</Link></li>
              </ul>
            </div>
            <div>
              <div className="font-mono text-[10px] uppercase tracking-[0.14em] text-zinc-400 mb-3">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="mailto:hl4929@nyu.edu" className="hover:text-zinc-950 text-zinc-600">
                    hl4929@nyu.edu
                  </Link>
                </li>
              </ul>
