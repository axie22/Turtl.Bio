    ...
    >
      <div className="max-w-[900px]">
        <h1 className="text-[44px] leading-[1.04] md:text-[72px] md:leading-[0.98] tracking-[-0.02em] font-normal">
          The questions you bring to FDA are only as good as the interpretation
          behind them.
        </h1>
        <p className="mt-8 max-w-[620px] text-[17px] leading-relaxed text-zinc-600">
          Before you walk into a pre-IND meeting, every grey zone call you
          haven&rsquo;t resolved is a question you&rsquo;re asking FDA to answer
          for you. Turtl does the interpretation work first.
        </p>
